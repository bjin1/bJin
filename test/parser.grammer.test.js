...
const syntaxChecks = [
  ...
  ["function with no params, no return type", "func f() {}"],
  ["function with one param", "func f(x: int) {}"],
  ["function with two params", "func f(x: int, y: bool) {}"],
  ["function with no params + return type", "func f(): int {}"],
  ["function types in params", "func f(g: (int)->bool) {}"],
  ["function types returned", "func f(): (int)->(int)->void {}"],
  ["list type for param", "func f(x: [[[bool]]]) {}"],
  ["list type returned", "func f(): [[int]] {}"],
  ...
  ["bool literals", "let x = false || true;"],
  ["all numeric literal forms", "print(8 * 89.123 * 1.3E5 * 1.3E+5 * 1.3E-5);"],
  ["empty list literal", "print(emptyListOf(int));"],
  ["nonempty list literal", "print([1, 2, 3]);"],
...
const syntaxErrors = [
  ...
  ["unbalanced brackets", "func f(): int[;", /Line 1, col 14/],
  ["fake list literal", "print([1,2,]);", /Line 1, col 12/],
  ["empty subscript", "print(a[]);", /Line 1, col 9/],
  ["true is reserved", "true = 1;", /Line 1, col 1/],
  ["false is reserved", "false = 1;", /Line 1, col 1/],
  ["no-paren function type", "func f(g:int->int) {}", /Line 1, col 13/],
